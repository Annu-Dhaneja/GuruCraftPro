...
export default function SpiritualSanctuaryPage() {
            ...
            <main className="relative z-10 pt-32 lg:pt-48 px-8 lg:px-16 max-w-screen-2xl mx-auto">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-40">
                    <div>
                        ...
                        >
                            ...
                            <span>Sacred Digital Presence</span>
                        </motion.div>
                        <motion.h1 
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            Immerse in <br />
                            <span className="text-shimmer bg-clip-text text-transparent bg-gradient-to-r from-amber-500 via-amber-200 to-amber-500">Divine Wisdom</span>
                        </motion.h1>
                        <motion.p 
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            Experience the intersection of ancient spirituality and modern artistry through AI-curated vachans and high-fidelity 3D spiritual assets.
                        </motion.p>
                ...
                <section className="mb-40 relative">
                    ...
                    <div className="relative p-12 lg:p-20 flex flex-col lg:flex-row items-center justify-between gap-12">
                        <div className="max-w-xl">
                            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-500 mb-6">Daily Vachan</p>
                            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter italic leading-[0.9] mb-8">
                                "Infinite peace begins within the soul."
                            </h2>
                            <p className="text-slate-400 font-medium italic mb-12">
                                Receive a personalized AI-generated spiritual quote every morning based on your journey and meditation goals.
                            </p>
                ...
                <section className="mb-40">
                    <div className="flex justify-between items-end mb-16">
                        <h2 className="text-4xl font-black uppercase italic tracking-tighter">Sacred <span className="text-amber-500">Store</span></h2>
