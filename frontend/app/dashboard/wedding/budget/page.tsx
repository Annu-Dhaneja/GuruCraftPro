                ...
                <div className="mb-16">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div className="max-w-2xl">
                            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-[10px] font-black tracking-[0.3em] uppercase text-primary mb-6">
                                <Sparkles className="w-3 h-3" /><span>Financial Intelligence</span>
                            </motion.div>
                            <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase italic leading-[0.9] text-white">
                                SMART <span className="text-primary">BUDGET</span> <br />OPTIMIZER
                            </h1>
                        </div>
                        <p className="text-slate-400 text-lg font-light italic leading-relaxed max-w-sm">Allocate your funds with precision using our AI recommendations.</p>
                    </div>
                </div>
