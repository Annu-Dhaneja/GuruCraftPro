        ...
        <section className="pt-32 pb-16 bg-background relative overflow-hidden text-center">
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <motion.h1
                    ...
                    dangerouslySetInnerHTML={{ __html: data?.title || "Let's talk about your <br /> <span class='text-indigo-500'>design needs</span>" }}
                />
                <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    ...
                    dangerouslySetInnerHTML={{ __html: data?.description || "Whether you need AI-powered visuals or a fully custom design, share your idea and we’ll take it forward." }}
                />
            </div>
