...
export function GurujiArtContent({ data }: { data?: GurujiArtData }) {
  ...
  const products = data?.products || [
    {
      ...
      description: "A transcendental masterpiece on archival canvas. Channeled through 40 days of silence, featuring sacred geometry and an indigo-violet aura that radiates tranquility.",
      price: "₹14,999",
    ...
    },
    {
      ...
      description: "High-vibrational digital painting optimized for 8K displays. Features a radiant violet blessing field designed to enhance spiritual frequency.",
      price: "₹1,499",
  ...
  return (
    <div className="flex flex-col bg-zinc-950 text-white selection:bg-indigo-500/30 overflow-x-hidden font-sans">
      {/* ── Fixed Cart Button ────────────────────────── */}
      <div className="fixed top-24 right-8 z-[100]">
        <Button className="h-16 w-16 rounded-full bg-white text-black shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-110 active:scale-95 transition-all relative">
          ...
          {cartCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-indigo-600 text-white text-[10px] h-6 w-6 flex items-center justify-center rounded-full font-black border-2 border-zinc-950">
              {cartCount}
            </span>
          )}
        </Button>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/4 w-[800px] h-[800px] bg-indigo-600/5 blur-[180px] rounded-full animate-pulse [animation-duration:12s]" />
      </div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-32 px-6">
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <motion.div
            ...
            className="mb-12 inline-flex items-center gap-3 px-8 py-3 rounded-full bg-indigo-500/5 border border-indigo-500/10 backdrop-blur-3xl"
          >
            <Sparkles className="w-4 h-4 text-indigo-500" />
            <span className="text-[10px] font-black tracking-[0.5em] uppercase text-indigo-200">{hero.subtitle}</span>
          </motion.div>
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="flex gap-4 items-center px-6 py-2 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                ...
                <span className="text-sm font-black uppercase tracking-widest text-indigo-100">7-Day Divine Consultation Available</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          {products.map((product, i) => (
            <motion.div
              ...
              className="group flex flex-col rounded-[3.5rem] bg-zinc-950/40 border border-white/5 hover:border-indigo-500/20 transition-all duration-700 glass-card overflow-hidden shadow-2xl"
            >
              ...
              <div className="p-12 flex flex-col flex-grow text-left">
                <div className="mb-6 flex justify-between items-start">
                    <h3 className="text-3xl font-black italic tracking-tight text-white group-hover:text-indigo-500 transition-colors uppercase">
                    {product.title}
                    </h3>
                    <div className="text-zinc-600 font-black text-[10px] uppercase tracking-widest">{product.category || "Sacred Art"}</div>
                </div>
                
                <p className="text-zinc-500 text-base font-light mb-12 leading-relaxed italic border-l border-indigo-500/20 pl-6 h-24 overflow-hidden">
                  {product.description}
                </p>
                ...
                <div className="mt-auto">
                    <div className="flex items-end justify-between mb-10">
                        ...
                        <div className="text-indigo-500 flex gap-1">
                    ...
                    <div className="flex gap-4">
                        ...
                        <Button className="flex-1 h-20 rounded-2xl bg-indigo-600 text-white hover:bg-white hover:text-black font-black uppercase transition-all shadow-xl shadow-indigo-600/20">
                            Buy Now
                        </Button>
                    </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
                ...
                <div className="absolute bottom-12 left-12">
                    ...
                    <p className="text-indigo-500 font-black uppercase tracking-widest text-sm">Divine Sprint</p>
                </div>
            </motion.div>
      ...
      <section className="py-64 text-center relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-indigo-600/5 blur-[200px] rounded-full pointer-events-none" />
        <Award className="w-20 h-20 text-indigo-500/50 mx-auto mb-16 animate-pulse" />
        ...
        <Button size="lg" className="bg-indigo-600 hover:bg-white hover:text-black text-white rounded-2xl px-24 h-28 text-3xl font-black shadow-[0_0_100px_rgba(99,102,241,0.3)] transition-all active:scale-95" asChild>
