        ...
        <div className="min-h-screen bg-[#020617] text-white selection:bg-indigo-500/30">
            ...
            <nav className={cn(
                ...
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-500 to-indigo-200 p-0.5">
                        <div className="w-full h-full rounded-full bg-[#020617] flex items-center justify-center">
                            <Flower className="w-5 h-5 text-indigo-400" />
                        </div>
                    </div>
                    <span className="text-sm font-black uppercase tracking-[0.3em] italic">Guru Ji Art <span className="text-indigo-500">Work</span></span>
                </div>
                <div className="flex items-center gap-6">
                    ...
                    <Button className="rounded-full bg-indigo-500 hover:bg-indigo-400 text-black font-black px-6 shadow-[0_0_20px_rgba(99,102,241,0.3)]">
                        DARSHAN
                    </Button>
                </div>
            </nav>
            ...
            <main className="relative z-10 pt-32 lg:pt-48 px-8 lg:px-16 max-w-screen-2xl mx-auto">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-40">
                    <div>
                        <motion.div
                            ...
                            className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-black tracking-[0.4em] uppercase text-indigo-500 mb-8"
                        >
                        ...
                        >
                            ...
                            <span className="text-shimmer bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-indigo-200 to-indigo-500">{hero.title_highlight || "Divine Wisdom"}</span>
                        </motion.h1>
                        <motion.p 
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        <div className="flex flex-wrap gap-6">
                            <Button className="h-16 px-10 rounded-[2rem] bg-indigo-500 text-black font-black text-sm uppercase tracking-widest shadow-[0_20px_50px_rgba(99,102,241,0.2)] hover:scale-105 transition-all">
                                EXPLORE COLLECTION
                            </Button>
                    ...
                    >
                        <div className="absolute inset-0 bg-indigo-500/20 blur-[150px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
                        <div className="relative glass-card rounded-[4rem] p-4 aspect-square overflow-hidden border-indigo-500/20">
                            <img 
                            ...
                            {/* AR Label */}
                            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-black/40 backdrop-blur-xl px-6 py-3 rounded-2xl border border-white/10 group-hover:border-indigo-500/50 transition-all">
                                <div className="p-2 rounded-lg bg-indigo-500/20 text-indigo-500">
                                    <Eye className="w-4 h-4" />
                                </div>
                                <div className="text-left">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-indigo-500">Live Preview</p>
                ...
                <section className="mb-40 relative">
                    ...
                    <div className="relative p-12 lg:p-20 flex flex-col lg:flex-row items-center justify-between gap-12">
                        <div className="max-w-xl">
                            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-500 mb-6">{vachan.badge || "Daily Vachan"}</p>
                ...
                <section className="mb-40">
                    <div className="flex justify-between items-end mb-16">
                        <h2 className="text-4xl font-black uppercase italic tracking-tighter">{store.title_prefix || "Sacred"} <span className="text-indigo-500">{store.title_highlight || "Store"}</span></h2>
                        <Link href="/shop" className="text-xs font-black uppercase tracking-widest text-slate-500 hover:text-indigo-500 transition-colors flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {products.map((product, i) => (
                            ...
                            >
                                <div className="glass-card rounded-[3rem] p-4 mb-6 border-white/5 group-hover:border-indigo-500/20">
                                    <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-slate-900">
                                        ...
                                        <div className="absolute top-8 left-8">
                                            <span className="bg-indigo-500 text-black text-[9px] font-black px-3 py-1 rounded-full uppercase tracking-widest">{product.badge}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="px-4">
                                    ...
                                    <Button className="w-full h-12 rounded-2xl bg-white/5 border border-white/10 hover:bg-indigo-500 hover:text-black hover:border-indigo-500 font-black text-[10px] uppercase tracking-widest transition-all">
                                        ADD TO CART
                                    </Button>
                                </div>
                            </motion.div>
            ...
            <footer className="relative z-10 border-t border-white/5 bg-[#020617]/50 backdrop-blur-xl py-20 px-16">
                <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                    <div className="flex items-center gap-4">
                        <Flower className="w-8 h-8 text-indigo-500" />
